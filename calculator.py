...
def samadengan():
    ...
    if mtk == "penjumlahan":
        ...
        try:
            ...
            e.insert(0,"laptop anda kentang")
    elif mtk == "perkalian":
        e.insert(0,n_awal * int(nomor_akhir))
    elif mtk == "sisabagi":
        e.insert(0,n_awal % int(nomor_akhir))
...
pang=Button(root,text="x²",padx = 30,bg="#878787",fg="white",pady=20,command=pangkat)
ak2=Button(root,text="√",padx = 25,bg="#878787",fg="white",pady=20,command=akar)
...
equal.grid(row=5,column=2,columnspan=2,pady=2)
